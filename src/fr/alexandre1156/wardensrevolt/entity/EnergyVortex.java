...
public class EnergyVortex extends EntityVindicator implements IRangedEntity{

	@SuppressWarnings("rawtypes")
	public EnergyVortex(World arg0) {
		super(arg0);
        ...
        this.getAttributeInstance(GenericAttributes.maxHealth).setValue(80f);
        this.setHealth(80f);
	}
	...
	public void a(EntityLiving arg0, float arg1) {
		...
		Collection<Entity> ents = ConfigList.world.getNearbyEntities(loc, 6, 6, 6);
		Iterator<Entity> iter = ents.iterator();
		while(iter.hasNext()){
			Entity ent = iter.next();
			if(ent instanceof Player)
				((Player) ent).damage(10d);
		}
	}
